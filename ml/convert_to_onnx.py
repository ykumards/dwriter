...
"""
Code from transformers.js https://github.com/xenova/transformers.js/blob/main/scripts/convert.py
Modification: Removed optimze flag from quantize_dynamic function (seems to be deprecated)
"""
import json
import os
import shutil
